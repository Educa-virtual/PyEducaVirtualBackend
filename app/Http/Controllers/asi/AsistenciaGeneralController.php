...
{
    public function obtenerAsistenciaEstudiante($anio, $mes, Request $request)
    {
        try {
            ...
            $asistencia = AsistenciaGeneralService::obtenerAsistenciaEstudiante($matricula->iMatrId,$anio, $mes);
